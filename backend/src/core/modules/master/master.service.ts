...
export class MasterService {
    static async promoteUser(id: number) 
    {
        ...
        await MasterErrors.ensureRole(prisma.user, id, adminRole.id, 'Usuário ja é admin.');
    ...
    static async demoteUser(id: number) 
    {
        ...
        await MasterErrors.ensureRole(prisma.user, id, userRole.id, 'Usuário ja é user.');
